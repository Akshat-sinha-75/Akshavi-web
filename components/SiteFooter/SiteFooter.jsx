    ...
    <footer id="main-footer">
      <div className="footer-top">
        <div className="footer-brand">
          <h1 className="f-logo">AKSHAVI</h1>
          <p className="f-desc">
            AKSHAVI protects lives through intelligent safety infrastructure. <br />
        ...
        <div className="footer-links">
          <div className="f-col">
            ...
            <a href="#projects-section">How It Works</a>
            <a href="#contact-section">Download</a>
          </div>
          <div className="f-col">
            <h3>CONTACT</h3>
