...
const MenuButton = ({ isScrolled }) => {
  ...
  return (
    <>
      ...
      >
        <div className={`overflow-hidden whitespace-nowrap transition-all duration-700 ease-in-out ${isScrolled ? 'max-w-0 opacity-0' : 'max-w-[100px] opacity-100'}`}>
