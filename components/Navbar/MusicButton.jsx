  ...
  return (
    ...
    >
      <div className="flex items-center justify-center">
        ...
        <span className={`overflow-hidden whitespace-nowrap transition-all duration-700 ease-in-out ${isScrolled ? 'max-w-0 opacity-0 ml-0' : 'max-w-[50px] opacity-100 ml-2'}`}>
          {label}
        </span>
      </div>
    </button>
